...
export interface ProductReviewImageAttributes {
  id: string;
  reviewId: string;
  imageUrl: string;
  createdAt?: Date;
...
export interface ProductReviewImageCreationAttributes
  extends Optional<ProductReviewImageAttributes, 'id'> {}

// ─── Model class ──────────────────────────────────────────────────────────────

class ProductReviewImage
  extends Model<ProductReviewImageAttributes, ProductReviewImageCreationAttributes>
  implements ProductReviewImageAttributes
{
  declare id: string;
