...
export const listProductsSchema: FastifySchema = {
  ...
  querystring: {
    ...
    properties: {
      ...
      lat: { type: 'number', minimum: -90, maximum: 90, description: 'User latitude — enables geofence filtering using platform setting `geofence_radius_km`' },
      lng: { type: 'number', minimum: -180, maximum: 180, description: 'User longitude — enables geofence filtering using platform setting `geofence_radius_km`' },
