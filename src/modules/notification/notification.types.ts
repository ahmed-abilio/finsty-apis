...
export const NotificationType = {
  ...
  ADMIN_STORE_APPLICATION: 'ADMIN_STORE_APPLICATION',
  ADMIN_COUPON_APPLICATION: 'ADMIN_COUPON_APPLICATION',
  ADMIN_BANNER_APPLICATION: 'ADMIN_BANNER_APPLICATION',
  VENDOR_STORE_APPROVED: 'VENDOR_STORE_APPROVED',
  VENDOR_STORE_REJECTED: 'VENDOR_STORE_REJECTED',
  VENDOR_COUPON_APPROVED: 'VENDOR_COUPON_APPROVED',
  VENDOR_BANNER_APPROVED: 'VENDOR_BANNER_APPROVED',
  VENDOR_ORDER_CANCELLED: 'VENDOR_ORDER_CANCELLED',
  RETURN_REQUESTED: 'RETURN_REQUESTED',
  VENDOR_RETURN_RECEIVED: 'VENDOR_RETURN_RECEIVED',
  RETURN_REFUND_APPROVED: 'RETURN_REFUND_APPROVED',
  RETURN_REFUND_REJECTED: 'RETURN_REFUND_REJECTED',
} as const;
